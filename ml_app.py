...
# import ml package
#Kegunaan untuk melakukan load model
import joblib # type: ignore
import os

# manual encoding untuk fitur2 kategorikal(bredasarkan encoding dari file pkl )
attribute_info = """
...
# fungsi bantuan untuk mendapatkan hasil encoding dari kategorikan value yang di pilih
def get_value(val, my_dict):
    for key, value in my_dict.items():
        if val == key:
            return value

# fungsi bantuan untuk mengimport model machine learning but prediksi
